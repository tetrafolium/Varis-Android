...
public class TestTimeConverter {
  ...
  public void testDurationToString() {
    ...
    String secondsAndMinutesString =
        String.format("%s %s", onlyMinutesString, onlySecondsString);
    String hoursMinutesAndSecondsString = String.format(
        "%s %s %s", onlyHoursString, onlyMinutesString, onlySecondsString);
    String hoursAndSecondsString =
        String.format("%s %s", onlyHoursString, onlySecondsString);
    String hoursAndMinutesString =
        String.format("%s %s", onlyHoursString, onlyMinutesString);
