...
public void testLoadBuildsHistory() {
	...
	when(mTravisRestClient.getApiService().getBuilds(slug))
	.thenReturn(Single.just(buildHistory));
...
public void testLoadBranches() {
	...
	when(mTravisRestClient.getApiService().getBranches(slug))
	.thenReturn(Single.just(branches));
...
public void testLoadRequests() {
	...
	when(mTravisRestClient.getApiService().getRequests(slug))
	.thenReturn(Single.just(requests));
	when(mTravisRestClient.getApiService().getPullRequestBuilds(slug))
	.thenReturn(Single.just(buildHistory));
