 ...
 */
public final class PullRequestsListAdapter
  ...
  public PullRequestsListAdapter(final Requests requests,
  ...
  public void setRequests(final Requests requests,
                          final List<RequestData> pullRequests) {
    mRequests = requests;
  ...
  private void bindPullRequest(final BuildViewHolder holder,
    ...
    holder.mBuildView.setTitle(holder.mBuildView.getContext().getString(
        R.string.pull_request_number, request.getPullRequestNumber()));
  }
