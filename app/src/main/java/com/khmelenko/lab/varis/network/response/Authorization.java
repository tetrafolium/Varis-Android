...
public final class Authorization {
  ...
  public List<String> getScopes() { return mScopes; }

  public void setScopes(final List<String> scopes) { mScopes = scopes; }

  public String getToken() { return mToken; }

  public void setToken(final String token) { mToken = token; }

  public String getTokenLastEight() { return mTokenLastEight; }

  public void setTokenLastEight(final String tokenLastEight) {
    mTokenLastEight = tokenLastEight;
  }

  public String getHashedToken() { return mHashedToken; }

  public void setHashedToken(final String hashedToken) {
    mHashedToken = hashedToken;
  }

  public App getApp() { return mApp; }

  public void setApp(final App app) { mApp = app; }

  public String getNote() { return mNote; }

  public void setNote(final String note) { mNote = note; }

  public String getNoteUrl() { return mNoteUrl; }

  public void setNoteUrl(final String noteUrl) { mNoteUrl = noteUrl; }

  public String getUpdatedAt() { return mUpdatedAt; }

  public void setUpdatedAt(final String updatedAt) { mUpdatedAt = updatedAt; }

  public String getCreatedAt() { return mCreatedAt; }

  public void setCreatedAt(final String createdAt) { mCreatedAt = createdAt; }
  ...
  public class App {
    ...
    public void setClientId(final String clientId) { mClientId = clientId; }
  }
}
