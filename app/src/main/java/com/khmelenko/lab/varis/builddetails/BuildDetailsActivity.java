 ...
 */
public final class BuildDetailsActivity
	extends MvpActivity<BuildsDetailsPresenter>
	implements BuildDetailsView, JobsFragment.JobsListener,
...
@BindView(R.id.progressbarview) View mProgressBar;

@BindView(R.id.build_details_build_data) View mBuildDetailsData;

@BindView(R.id.build_details_layout) ScrollView mBuildDetailsLayout;

@BindView(R.id.build_details_scroll_btn) FloatingActionButton mScrollBtn;

@BindView(R.id.build_details_scroll_up_btn) FloatingActionButton mScrollUpBtn;

@Inject BuildsDetailsPresenter mPresenter;
...
public void onJobSelected(final Job job) {
	...
	replaceFragment(R.id.build_details_container, mRawLogFragment,
	                RAW_LOG_FRAGMENT_TAG, null);
...
public void showAdditionalActionsForBuild(final BuildDetails details) {
	...
	if (mCanContributeToRepo) {
		mBuildInProgressState =
			BuildStateHelper.isInProgress(details.getBuild().getState());
...
public void showLoadingError(final String message) {
	String msg =
		getString(R.string.error_failed_loading_build_details, message);
...
public void showBuildLogs() {
	...
	addFragment(R.id.build_details_container, mRawLogFragment,
	            RAW_LOG_FRAGMENT_TAG);
}
