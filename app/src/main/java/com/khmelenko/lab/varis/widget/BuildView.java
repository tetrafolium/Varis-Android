...
public class BuildView extends LinearLayout {
  ...
  @BindView(R.id.build_indicator) View mIndicator;

  @BindView(R.id.build_number) TextView mTitle;

  @BindView(R.id.build_pull_request_title) TextView mPullRequest;

  @BindView(R.id.build_branch) TextView mBranch;

  @BindView(R.id.build_commit_message) TextView mCommitMessage;

  @BindView(R.id.build_commit_person) TextView mCommitPerson;

  @BindView(R.id.build_duration) TextView mDuration;

  @BindView(R.id.build_finished) TextView mFinished;
  ...
  public void setFinishedAt(final String finishedAt) {
    if (!TextUtils.isEmpty(finishedAt)) {
      ...
      formattedDate =
          getContext().getString(R.string.build_finished_at, formattedDate);
  ...
  public void setState(final IBuildState buildState) {
    if (buildState != null) {
      setTitle(getContext().getString(R.string.build_build_number,
   ...
   * @param title Title
   */
  public void setTitle(final String title) { mTitle.setText(title); }
  ...
  public void setStateIndicator(final String state) {
    if (!TextUtils.isEmpty(state)) {
      ...
      if (drawable != null) {
        mTitle.setCompoundDrawablesWithIntrinsicBounds(drawable, null, null,
                                                       null);
      }
    }
  }
