...
public final class User {
  ...
  public void setLogin(final String login) { mLogin = login; }

  public String getEmail() { return mEmail; }

  public void setEmail(final String email) { mEmail = email; }

  public String getGravatarId() { return mGravatarId; }
  ...
  public void setSyncing(final boolean syncing) { mSyncing = syncing; }

  public String getSyncedAt() { return mSyncedAt; }

  public void setSyncedAt(final String syncedAt) { mSyncedAt = syncedAt; }

  public boolean isCorrectScopes() { return mCorrectScopes; }
