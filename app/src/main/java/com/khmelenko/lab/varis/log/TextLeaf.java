...
final class TextLeaf implements LogEntryComponent {
  ...
  TextLeaf(final String text) { this(text, FormattingOptions.fromAnsiCodes()); }

  TextLeaf(final FormattingOptions options) { this("", options); }
  ...
  public FormattingOptions getOptions() { return mOptions; }
  ...
  public String toHtml() {
    ...
    if (mOptions.getTextColor() != null) {
      result =
          "<font color='" + mOptions.getTextColor() + "'>" + result + "</font>";
    } else {
